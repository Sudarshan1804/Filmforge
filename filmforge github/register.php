...
<head>
    ...
    <title>FilmForge - Registration</title>
...
<body class="font-inter bg-gray-100 dark:bg-gray-900 transition-colors duration-300 pt-16">
    ...
    <section class="min-h-screen flex items-center justify-center py-12 animate-on-scroll">
        <div class="max-w-md w-full mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 animate__animated animate__fadeInUp">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-6 text-shadow">Sign Up</h2>
            <?php if (isset($error)): ?>
            ...
            <?php endif; ?>
            <form id="register-form" action="register.php" method="POST" class="space-y-6">
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Full Name</label>
                    <input type="text" id="name" name="name" required class="mt-1 block h-9 w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-200" placeholder="Enter your full name">
                </div>
                <div>
                ...
                <div>
                    <button type="submit" class="w-full bg-indigo-600 dark:bg-indigo-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-indigo-700 dark:hover:bg-indigo-600 btn-animated">Create Account</button>
                </div>
            </form>
            <p class="mt-4 text-center text-sm text-gray-600 dark:text-gray-300">
                Already have an account? <a href="login.php" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300">Sign In</a>
            </p>
        </div>
    </section>
